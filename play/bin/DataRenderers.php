...
class Form
{
	...
	// When sending objects to the client side this function will return which attributes to html.
	// Only html those attributes specified in the form options. The primary key must always be
	// included.
