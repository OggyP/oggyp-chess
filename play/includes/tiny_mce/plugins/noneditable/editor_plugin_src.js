...
(function() {
	...
	function handleContentEditableSelection(ed) {
		...
		// Insert caret container before/after target or expand selection to html block
		...
		// Modifies the selection to html contentEditable false elements or insert caret containers
		function moveSelection() {
			...
			if (nonEditableStart || nonEditableEnd) {
				...
				if (isCollapsed) {
					...
					// Expand selection to html start non editable element
					if (nonEditableStart) {
						rng.setStartBefore(nonEditableStart);
					}

					// Expand selection to html end non editable element
					if (nonEditableEnd) {
